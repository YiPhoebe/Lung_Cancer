### ✅ main_train_mga_no_rotate.py (MGA ⭕️ / 마스크 회전 ❌)
...
from ResNet18_CBAM_MGA.core.utils import generate_run_name, split_by_patient_3way 
...
def main():
    ...
    df.to_csv("logs/train_log_mga_no_rotate_3way.csv", index=False)
    print("📁 logs/train_log_mga_no_rotate_3way.csv 저장 완료")
    print("🎉 학습 종료")
