### ✅ main_train_softmga.py (MGA ⭕️ / 마스크 회전 ⭕️)
...
from ResNet18_CBAM_MGA.train.train_softmga import train_one_epoch, validate
...
def main():
    ...
    df.to_csv("logs/train_log_softmga.csv", index=False)
    print("📁 logs/train_log_softmga.csv 저장 완료")
    print("🎉 학습 종료")
